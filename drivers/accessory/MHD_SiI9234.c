...
void MHD_HW_Device_init(void)		//hmyun
{
	//pr_info("[SIMG]MHD_HW_Device_init == Start == \n");
	SII9234_HW_Device_init(SII9234_i2c_client);
	printk("[YHM] MHD_HW_Device_init \n");
}
...
void MHD_HW_Off(void)
{
	...
	//printk("<--YHM-->mhl_hpd_handler_off--\n");
}
