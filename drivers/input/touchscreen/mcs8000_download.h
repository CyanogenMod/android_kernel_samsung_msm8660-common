...
int mcsdl_download_binary_data(struct melfas_tsi_platform_data *data);			// with binary type .c   file.
int mcsdl_download_binary_file(struct melfas_tsi_platform_data *data);			// with binary type .bin file.
