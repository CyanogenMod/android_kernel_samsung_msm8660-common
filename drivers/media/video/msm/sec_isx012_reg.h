...
#ifndef __SEC_ISX012_REG_H
#define __SEC_ISX012_REG_H

#define ISX012_DELAY_RETRIES_OM	30	//for OM
#define ISX012_DELAY_RETRIES_CM	160	//for CM

#define ISX012_DELAY_RETRIES	100	//for modesel_fix, awbsts, half_move_sts
#define ISX012_DELAY_RETRIES2	25	//for hunting
...
{0x6668,0x02A8,0x02},    // AF_AREA_HIGH_TYPE1 :
...
{0x6742,0x0028,0x02},    // AF_SEARCH_OFFSET_FAR :
...
{0x033B,0x14,0x01},    // AGCGAIN2_TYPE4
{0x033C,0x10,0x01},    // SHTCTRLTIME3_TYPE4
...
{0x0357,0x00,0x01},    // AGCGAIN1_TYPE9 : 
{0x0358,0x01,0x01},    // SHTCTRLTIME2_TYPE9 : 
{0x0359,0x00,0x01},    // AGCGAIN2_TYPE9 : 
{0x035A,0xF8,0x01},    // SHTCTRLTIME3_TYPE9 : 
{0x035B,0x00,0x01},    // AGCGAIN3_TYPE9 : 

// fire mode AF line
{0x035C,0x01,0x01},    // SHTCTRLTIME1_TYPE10 : 
{0x035D,0x00,0x01},    // AGCGAIN1_TYPE10 : 
{0x035E,0x01,0x01},    // SHTCTRLTIME2_TYPE10 : 
{0x035F,0x00,0x01},    // AGCGAIN2_TYPE10 : 
{0x0360,0xFF,0x01},    // SHTCTRLTIME3_TYPE10 : 
{0x0361,0x00,0x01},    // AGCGAIN3_TYPE10 : 
...
{0x7058,0x0066,0x02},    // G0_KNOT_L_G8 :
{0x705A,0x006F,0x02},    // G0_KNOT_L_G9 :
{0x705C,0x004E,0x02},    // G0_KNOT_L_G10 :
{0x705E,0x0087,0x02},    // G0_KNOT_L_G11 :
{0x7060,0x00AA,0x02},    // G0_KNOT_L_G12 :
{0x7062,0x00C6,0x02},    // G0_KNOT_L_G13 :
{0x7064,0x00E1,0x02},    // G0_KNOT_L_G14 :
{0x7066,0x00F2,0x02},    // G0_KNOT_L_G15 :
{0x7068,0x00FF,0x02},    // G0_KNOT_L_G16 :
...
{0x629B,0x41,0x01},    // CAT_AWB_3 : outdoor_����ġ on
{0x625F,0x15,0x01},    // CAT_AWB_1 : MWB�� user��ǥ�� ��ǥ ���(AWB�ÿ��� ���� ��)
...
{0x9530,0x0000,0x02},    // AP_N_LD_DARK_SLOPE_A : << N�뿪 LevelDepend ���ֵ��� ������ A�����
{0x9532,0x0000,0x02},
...
{0x953E,0x0000,0x02},
{0x9540,0x0061,0x02},    // AP_N_LD_HIGH_SLOPE0_A : << N�뿪 LevelDepend ���ֵ��� �Ӱ�ġ0���Ӱ�ġ1������ ������ A�����
{0x9542,0x0000,0x02},
...
{0x954E,0x0000,0x02},
{0x9550,0x001C,0x02},    // AP_N_LD_HIGH_SLOPE1_A : <<N�뿪 LevelDepend ���ֵ��� �Ӱ�ġ1���Ӱ�ġ2������ ������ A�����
{0x9552,0x0000,0x02},
...
{0x955E,0x0000,0x02},
{0x9560,0x0000,0x02},    // AP_N_LD_HIGH_SLOPE2_A : <<N�뿪 LevelDepend ���ֵ��� �Ӱ�ġ2��˽�� ������ A�����
{0x9562,0x0000,0x02},
...
{0x956E,0x0000,0x02},
{0x9570,0x0000,0x02},    // AP_H_LD_DARK_SLOPE_A : <<H�뿪 LevelDepend ���ֵ��� ������ A�����
{0x9572,0x0000,0x02},
...
{0x957E,0x0000,0x02},
{0x9580,0x0025,0x02},    // AP_H_LD_HIGH_SLOPE0_A : <<H�뿪 LevelDepend ���ֵ��� �Ӱ�ġ0���Ӱ�ġ1������ ������ A�����
{0x9582,0x0000,0x02},
...
{0x958E,0x0000,0x02},
{0x9590,0x0050,0x02},    // AP_H_LD_HIGH_SLOPE1_A : <<H�뿪 LevelDepend ���ֵ��� �Ӱ�ġ1���Ӱ�ġ2������ ������ A�����
{0x9592,0x0000,0x02},
...
{0x959E,0x0000,0x02},
{0x95A0,0x0000,0x02},    // AP_H_LD_HIGH_SLOPE2_A : <<H�뿪 LevelDepend ���ֵ��� �Ӱ�ġ2��˽�� ������ A�����
{0x95A2,0x0000,0x02},
...
{0x95AE,0x0000,0x02},
{0x95B0,0x0000,0x02},    // AP_L_LD_DARK_SLOPE_A : <<L�뿪 LevelDepend ���ֵ��� ������ A�����
{0x95B2,0x0000,0x02},
...
{0x95BE,0x0000,0x02},
{0x95C0,0x0020,0x02},    // AP_L_LD_HIGH_SLOPE0_A : <<L�뿪 LevelDepend ���ֵ��� �Ӱ�ġ0���Ӱ�ġ1������ ������ A���
{0x95C2,0x0000,0x02},
...
{0x95CE,0x0000,0x02},
{0x95D0,0x0051,0x02},    // AP_L_LD_HIGH_SLOPE1_A : <<L�뿪 LevelDepend ���ֵ��� �Ӱ�ġ1���Ӱ�ġ2������ ������ A�����
{0x95D2,0x0000,0x02},
...
{0x95DE,0x0000,0x02},
{0x95E0,0x0000,0x02},    // AP_L_LD_HIGH_SLOPE2_A : <<L�뿪 LevelDepend ���ֵ��� �Ӱ�ġ2��˽�� ������ A�����
{0x95E2,0x0000,0x02},
...
{0x62CA,0x0080,0x02},    // A_LIGHT_AIM_SHIFT_R :
{0x62CC,0x0120,0x02},    // A_LIGHT_AIM_SHIFT_B :
...
{0x030C,0x18,0x01},    //AELINE_MONI_SN9_10 : 
...
{0x0312,0x18,0x01},    //AELINE_HALF_SN9_10 : 
...
{0x0318,0x18,0x01},    //AELINE_HALF_AFEND_SN9_10 : 
...
// size address data
//
isx012_short_t ISX012_Pll_Setting_2[] =
{
...
// size address data
//
isx012_short_t ISX012_Pll_Setting_3[] =
{
...
// size address data
//
isx012_short_t ISX012_Pll_Setting_4[] =
{
{0x0007,0x00,0x01},                  // PLL_CKSEL                 : PLL 432MHz
{0x0008,0x00,0x01},                  // SRCCK_DIV                 : 1/5 frequency
...
isx012_short_t ISX012_Preview_SizeSetting[] =
{
{0x0090,0x0280,0x02},    //HSIZE_MONI : 640
{0x0096,0x01E0,0x02},    //VSIZE_MONI : 480
};

isx012_short_t ISX012_Preview_Mode[] =
{
{0x0089,0x00,0x01},    //OUTFMT_MONI
{0x0083,0x01,0x01},    //SENSMODE_MONI
{0x0086,0x02,0x01},    //FPSTYPE_MONI
...
{0x00B2,0x02,0x01},    // AFMODE_MONI : Continous mode
...
//Gammma Table 0
{0x7000,0x0000,0x02},    // G0_KNOT_G0 :
{0x7002,0x000A,0x02},    // G0_KNOT_G1 :
{0x7004,0x0023,0x02},    // G0_KNOT_G2 :
...
{0x7048,0x0000,0x02},    // G0_KNOT_L_G0 :
{0x704A,0x0007,0x02},    // G0_KNOT_L_G1 :
{0x704C,0x001D,0x02},    // G0_KNOT_L_G2 :
...
isx012_short_t ISX012_Halfrelease_Mode[] =
{
...
isx012_short_t ISX012_Barcode_SAF[] =
{
{0x00B1,0x01,0x01},    //AF_RESTART_F :
{0xFFFF,0x21,0x01},    //$wait, 33
...
isx012_short_t ISX012_Lowlux_night_Halfrelease_Mode[] =
{
...
isx012_short_t ISX012_AF_Cancel_Macro_ON[] =
{
{0x00B2,0x02,0x01},    //AFMODE_MONI : Manual AF mode
...
isx012_short_t ISX012_AF_Cancel_Macro_OFF[] =
{
{0x00B2,0x02,0x01},    //AFMODE_MONI : Manual AF mode
{0x0081,0x00,0x01},    //MODESEL : Monitoring mode
{0xFFFF,0x96,0x01},	//$wait, 66
...
isx012_short_t ISX012_AF_ReStart[] =
{
{0x00B1,0x01,0x01},    //AF_RESTART_F
};

isx012_short_t ISX012_AF_Macro_OFF[] =
{
{0x0081,0x00,0x01},    //MODESEL : Monitoring mode
{0x6648,0x00C8,0x02},    //AF_MANUAL_POS : MANUA AF search start position
...
isx012_short_t ISX012_AF_Macro_ON[] =
{
{0x0081,0x00,0x01},    //MODESEL : Monitoring mode
{0x6648,0x02A8,0x02},    //AF_MANUAL_POS : MANUA AF search start position
...
isx012_short_t ISX012_AF_SAF_OFF[] = 
{
...
isx012_short_t ISX012_AF_TouchSAF_OFF[] = 
{
{0x00B2,0x03,0x01},    //AFMODE_MONI : AF OFF
{0x00B3,0x03,0x01},    //AFMODE_HREL : AF OFF
{0xFFFF,0x21,0x01},    //$wait,33
...
isx012_short_t isx012_Contrast_Minus_2[] =
{
{0x01C7,0x58,0x01},    //UICONTRAST
};

isx012_short_t isx012_Contrast_Minus_1[] =
{
{0x01C7,0x6C,0x01},    //UICONTRAST
};

isx012_short_t isx012_Contrast_Default[] =
{
{0x01C7,0x80,0x01},    //UICONTRAST
};

isx012_short_t isx012_Contrast_Plus_1[] =
{
{0x01C7,0x94,0x01},    //UICONTRAST
};

isx012_short_t isx012_Contrast_Plus_2[] =
{
{0x01C7,0xA8,0x01},    //UICONTRAST
};

isx012_short_t isx012_Effect_Black_White[] =
{
{0x01C5,0x04,0x01},    //FMODE
};

isx012_short_t ISX012_Effect_Negative[] =
{
{0x01C5,0x02,0x01},    //FMODE
};

isx012_short_t isx012_Effect_Normal[] =
{
{0x01C5,0x00,0x01},    //FMODE
};

isx012_short_t isx012_Effect_Sepia[] =
{
{0x01C5,0x03,0x01},    //FMODE
};

isx012_short_t isx012_Metering_Center[] =
{
{0x02AC,0x01,0x01},    //AE_SUB_SN1
{0x02B6,0x01,0x01},    //AE_SUB_SN11
};

isx012_short_t isx012_Metering_Matrix[] =
{
{0x02AC,0x00,0x01},    //AE_SUB_SN1
};

isx012_short_t isx012_Metering_Spot[] =
{
{0x02AC,0x02,0x01},    //AE_SUB_SN1
{0x02B6,0x02,0x01},    //AE_SUB_SN11
};

isx012_short_t ISX012_ExpSetting_Default[] =
{
{0x0180,0x00,0x01},    //EVSEL
};

isx012_short_t ISX012_ExpSetting_M1Step[] =
{
{0x0180,0xFF,0x01},    //EVSEL
};

isx012_short_t ISX012_ExpSetting_M2Step[] =
{
{0x0180,0xFE,0x01},    //EVSEL
};

isx012_short_t ISX012_ExpSetting_M3Step[] =
{
{0x0180,0xFD,0x01},    //EVSEL
};

isx012_short_t ISX012_ExpSetting_M4Step[] =
{
{0x0180,0xFC,0x01},    //EVSEL
};

isx012_short_t ISX012_ExpSetting_P1Step[] =
{
{0x0180,0x01,0x01},    //EVSEL
};

isx012_short_t ISX012_ExpSetting_P2Step[] =
{
{0x0180,0x02,0x01},    //EVSEL
};

isx012_short_t ISX012_ExpSetting_P3Step[] =
{
{0x0180,0x03,0x01},    //EVSEL
};

isx012_short_t ISX012_ExpSetting_P4Step[] =
{
{0x0180,0x04,0x01},    //EVSEL
};

isx012_short_t isx012_ISO_50[] =
{
...
isx012_short_t isx012_ISO_Auto[] =
{
...
isx012_short_t ISX012_Capture_SizeSetting[] =
{
{0x0092,0x0A20,0x02},    //HSIZE_CAP : 2592
{0x0098,0x0798,0x02},    //VSIZE_CAP : 1944
};

isx012_short_t ISX012_Capture_Mode[] =
{
...
isx012_short_t ISX012_Lowlux_Night_Capture_Mode[] =
{
{0x03A0,0x93,0x01},    //UISATURATION_TYPE3 :
...
isx012_short_t isx012_Saturation_Default[] =
{
{0x039E,0x80,0x01},    //UISATURATION_TYPE1
};

isx012_short_t isx012_Saturation_Minus_1[] =
{
{0x039E,0x62,0x01},    //UISATURATION_TYPE1
};

isx012_short_t isx012_Saturation_Minus_2[] =
{
{0x039E,0x44,0x01},    //UISATURATION_TYPE1
};

isx012_short_t isx012_Saturation_Plus_1[] =
{
{0x039E,0x9E,0x01},    //UISATURATION_TYPE1
};

isx012_short_t isx012_Saturation_Plus_2[] =
{
{0x039E,0xBC,0x01},    //UISATURATION_TYPE1
};

isx012_short_t isx012_Scene_Default[] =
{
{0x02A8,0x00,0x01},    //ISO_TYPE1 : Auto
...
isx012_short_t isx012_Scene_Landscape[] =
{
{0x02A8,0x00,0x01},    //ISO_TYPE1 : Auto
{0x039F,0x9E,0x01},    //UISATURATION_TYPE2 :
...
isx012_short_t isx012_Scene_Sports[] =
{
{0x02A8,0x00,0x01},    //ISO_TYPE1 : Auto
{0x5E06,0x02,0x01},    //SHTCTRLMAG3 
{0x038F,0x00,0x01},    //PICT1_SN1 :
...
isx012_short_t isx012_Scene_Party_Indoor[] =
{
...
isx012_short_t isx012_Scene_Beach_Snow [] =
{
...
isx012_short_t isx012_Scene_Sunset[] =
{
{0x02A8,0x00,0x01},    //ISO_TYPE1 : Auto
...
isx012_short_t isx012_Scene_Duskdawn[] =
{
{0x02A8,0x00,0x01},    //ISO_TYPE1 : Auto
...
isx012_short_t isx012_Scene_Candle_Light[] =
{
{0x02A8,0x00,0x01},    //ISO_TYPE1 : Auto
{0x0287,0x25,0x01},    //AWB_SN6 : daylight
{0x0394,0x00,0x01},    //PICT1_SN6 :
...
isx012_short_t isx012_Scene_Fall_Color[] =
{
{0x02A8,0x00,0x01},    //ISO_TYPE1 : Auto
...
isx012_short_t isx012_Scene_Portrait[] =
{
{0x02A8,0x00,0x01},    //ISO_TYPE1 : Auto
{0x5E06,0x02,0x01},    //SHTCTRLMAG3 
...
isx012_short_t isx012_Scene_Nightshot[] =
{
{0x02A8,0x00,0x01},    //ISO_TYPE1 : Auto
{0x5E06,0x02,0x01},    //SHTCTRLMAG3 
{0x038F,0x00,0x01},    //PICT1_SN1 :
...
isx012_short_t isx012_Scene_Fireworks[] =
{
{0x02A8,0x04,0x01},    //ISO_TYPE1 : ISO50
...
isx012_short_t isx012_Scene_Text[] =
{
{0x02A8,0x00,0x01},    //ISO_TYPE1 : Auto
...
isx012_short_t isx012_Scene_Backlight[] =
{
{0x02A8,0x00,0x01},    //ISO_TYPE1 : Auto
{0x5E06,0x02,0x01},    //SHTCTRLMAG3 
{0x038F,0x00,0x01},    //PICT1_SN1 :
...
isx012_short_t ISX012_Sensor_Off_VCM[] =
{
{0x00B2,0x02,0x01},    //AFMODE_MONI : Manual AF mode
{0x0081,0x00,0x01},    //MODESEL : Monitoring mode
{0x6648,0x00C8,0x02},    //AF_MANUAL_POS : MANUA AF search start position
...
isx012_short_t isx012_1280_Preview_E[] =
{
{0x0090,0x0500,0x02},	 //HSIZE_MONI : 1280
{0x0096,0x02D0,0x02},	 //VSIZE_MONI : 720

};
isx012_short_t isx012_800_Preview[] =
{
...
isx012_short_t isx012_720_Preview[] =
{
...
isx012_short_t isx012_640_Preview[] =
{
{0x0090,0x0280,0x02},	 //HSIZE_MONI : 640
{0x0096,0x01E0,0x02},	 //VSIZE_MONI : 480
};

isx012_short_t isx012_320_Preview[] =
{
{0x0090,0x0140,0x02},	 //HSIZE_MONI : 320
{0x0096,0x00F0,0x02},	 //VSIZE_MONI :240

};
isx012_short_t isx012_176_Preview[] =
{
...
isx012_short_t isx012_5M_Capture[] =
{
{0x0282,0x20,0x01},    //AWB_SN1

};
isx012_short_t isx012_4M_WIDE_Capture[] =
{
{0x0282,0x20,0x01},    //AWB_SN1

};
isx012_short_t isx012_2_4M_WIDE_Capture[] =
{
{0x0282,0x20,0x01},    //AWB_SN1

};
isx012_short_t isx012_1_5M_WIDE_Capture[] =
{
{0x0282,0x20,0x01},    //AWB_SN1

};
isx012_short_t isx012_1M_Capture[] =
{
{0x0282,0x20,0x01},    //AWB_SN1

};
isx012_short_t isx012_4K_WIDE_Capture[] =
{
{0x0282,0x20,0x01},    //AWB_SN1

};
isx012_short_t isx012_VGA_Capture[] =
{
{0x0282,0x20,0x01},    //AWB_SN1

};
isx012_short_t isx012_QVGA_Capture[] =
{
{0x0282,0x20,0x01},    //AWB_SN1

};
isx012_short_t isx012_DTP_init[] =
{
...
isx012_short_t isx012_DTP_stop[] =
{
...
isx012_short_t isx012_Preview_Return[] =
{
{0x0282,0x20,0x01},    //AWB_SN1

};

isx012_short_t isx012_Capture_Start[] =
{
	{0x008A,0x00,0x01},    //OUTFMT_CAP
	{0x0084,0x00,0x01},	  //SENSMODE_CAP
	{0x0087,0x03,0x01},    //FPSTYPE_CAP
...
#endif
isx012_short_t isx012_ae_lock[] =
{
{0x0282,0x20,0x01},    //AWB_SN1
};

isx012_short_t isx012_ae_unlock[] =
{
{0x0282,0x20,0x01},    //AWB_SN1
};

isx012_short_t isx012_awb_lock[] =
{
{0x0282,0x20,0x01},    //AWB_SN1
};

isx012_short_t isx012_awb_unlock[] =
{
{0x0282,0x20,0x01},    //AWB_SN1
};


isx012_short_t ISX012_Shading_Nocal[] =
{
...
//S, 6C32, 16A8, 16,    // SHD_INP_TH_HB_H_R2 
//S, 6C34, 1612, 16,    // SHD_INP_TH_HB_L_R2 
//S, 6C36, 0ED8, 16,    // SHD_INP_TH_LB_H_R2 
//S, 6C38, 0E10, 16,    // SHD_INP_TH_LB_L_R2 
//S, 6C3C, 0ED8, 16,    // SHD_INP_TH_HB_H_RB 
//S, 6C3E, 0E10, 16,    // SHD_INP_TH_HB_L_RB 
//S, 6C40, 0000, 16,    // SHD_INP_TH_LB_H_RB 
//S, 6C42, 0000, 16,    // SHD_INP_TH_LB_L_RB 
...
//PreWB offset SHD3(A)
{0x682C,0x0015,0x02},    // SHD_PRER_OFFSET_RB : 111121 ����
...
{0x6804,0x1157,0x02},//    NorR
{0x6806,0x0FB8,0x02},//    NorB
{0x6808,0x0146,0x02},//    PreR
{0x680A,0x0230,0x02},//    PreB

{0x6828,0x0017,0x02},    // SHD_PRER_OFFSET_R2 : 
};

isx012_short_t ISX012_Shading_0[] =
{
{0x01BC,0x50,0x01},    // CXC OFF SHD OFF
{0xEB00,0x8282,0x02},	//valid_code
{0xEB02,0x81,0x01},
...
isx012_short_t ISX012_Shading_1[] =
{
{0x01BC,0x50,0x01},    // CXC OFF SHD OFF
{0xEB00,0x8282,0x02},	//valid_code
{0xEB02,0x81,0x01},
...
//SHD2 TL84+CWF 66 33 R69G73B73 for index1
{0xEF54,0x5A,0x01},
{0xEF55,0xA2,0x01},
{0xEF56,0xD2,0x01},
{0xEF57,0x90,0x01},
...
//SHD3 D65+TL84(1:2) R69G73B73 for index1
{0xEFEE,0x6A,0x01},
{0xEFEF,0x1A,0x01},
{0xEFF0,0x93,0x01},
{0xEFF1,0x94,0x01},
...
isx012_short_t ISX012_Shading_2[] =
{
{0x01BC,0x50,0x01},    // CXC OFF SHD OFF
{0xEB00,0x8282,0x02},	//valid_code
{0xEB02,0x81,0x01},
...
//SHD2 TL84+CWF 66 33 R73G73B73 for index2
{0xEF54,0x7D,0x01},
{0xEF55,0x7A,0x01},
{0xEF56,0x53,0x01},
{0xEF57,0x96,0x01},
...
//SHD3 D65+TL84(1:2) R72G73B73 for index2
{0xEFEE,0x85,0x01},
{0xEFEF,0xC2,0x01},
{0xEFF0,0xD3,0x01},
{0xEFF1,0x98,0x01},
...
isx012_short_t ISX012_Lowlux_Night_Reset[] =
{
{0x039D,0x00,0x01},    //UIHUE_TYPE3 :
{0x03A0,0x80,0x01},    //UISATURATION_TYPE3 :
{0x982A,0xFFEC,0x02},	 // CS_CBLLEV_A :
