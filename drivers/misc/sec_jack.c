...
#elif defined (CONFIG_EUR_MODEL_GT_I9210)
#define KEY_VOLUMEUP_ADC_MIN 176
#define KEY_VOLUMEUP_ADC_MAX 350
#elif defined (CONFIG_USA_MODEL_SGH_I727) || defined(CONFIG_USA_MODEL_SGH_I757)
...
#define KEY_VOLUMEDOWN_ADC_MAX 681
#elif defined (CONFIG_EUR_MODEL_GT_I9210)
#define KEY_VOLUMEDOWN_ADC_MIN 351
#define KEY_VOLUMEDOWN_ADC_MAX 680
#elif defined (CONFIG_USA_MODEL_SGH_I727) || defined(CONFIG_USA_MODEL_SGH_I757)
