...
#if defined(CONFIG_KOR_MODEL_SHV_E160S)  /* QUINCY-SKT */
...
ADIE_HANDSET_LOOPBACK_RX_48000_256;


static struct adie_codec_hwsetting_entry handset_loopback_rx_settings[] = {
	{
		.freq_plan = DATA_SAMPLE_RATE,
		.osr = 256,
...
static struct adie_codec_dev_profile handset_loopback_rx_profile = {
...
static struct snddev_icodec_data handset_loopback_rx_data = {
	...
	.copp_id = 0,
	.profile = &handset_loopback_rx_profile,
	.channel_mode = 1,
	.default_sample_rate = DATA_SAMPLE_RATE,
};

static struct snddev_icodec_data handset_loopback_tx_data = {
#if 0 /* Factory test Frequency Fail */
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	...
	.default_sample_rate = DATA_SAMPLE_RATE,	
	.pamp_on = msm_snddev_enable_2mic_power, 
	.pamp_off = msm_snddev_enable_2mic_power,
#ifdef CONFIG_VP_A2220
	.a2220_vp_on = msm_snddev_handset_ns_on,
	.a2220_vp_off = msm_snddev_hw_bypass_on,	
#endif		
