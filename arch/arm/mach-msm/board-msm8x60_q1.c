...
#define MSM_FB_EXT_BUF_SIZE  \
		(roundup((1920 * 1088 * 2), 4096) * 2) /* 2 bpp x 2 page */
#else
...
#define MSM_ION_SF_SIZE		0x2900000 /* 64MB+ -> 41MB */
...
#if defined(CONFIG_ANDROID_RAM_CONSOLE) && defined(CONFIG_JPN_MODEL_SC_05D)
