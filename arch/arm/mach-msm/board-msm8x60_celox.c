...
static int lcdc_LD9040_panel_power(int enable)
{
	...
	printk(["[kmj] %s: l3 current voltage: %i", __FUNCTION__, regulator_get_voltage(l3));
	printk(["[kmj] %s: l19 current voltage: %i", __FUNCTION__, regulator_get_voltage(l19));
	printk(["[kmj] %s: l3 enabled: %i", __FUNCTION__, regulator_is_enabled(l3));
	printk(["[kmj] %s: l19 enabled: %i", __FUNCTION__, regulator_is_enabled(l19));
	printk(["[kmj] %s: end", __FUNCTION__);
