...
#define PMIC_GPIO_ESD_DET		PM8058_GPIO(26)  	/* PMIC GPIO Number 26, CMC624 IMA_INT*/
#define PMIC_GPIO_ESD_VGH		PM8058_GPIO(16)  	/* PMIC GPIO Number 16 */
...
static struct pm_gpio sec_mipi_esd_det_gpio_cfg = { // kyNam_110824_
		...
		.pull           = PM_GPIO_PULL_DN,//PM_GPIO_PULL_NO,
		.vin_sel        = PM_GPIO_VIN_L5, 
		.function       = PM_GPIO_FUNC_NORMAL,
		.inv_int_pol    = 0,
};
static struct pm_gpio sec_mipi_esd_vgh_det_gpio_cfg = { // kyNam_110824_
		.direction      = PM_GPIO_DIR_IN,
...
static struct sec_esd_platform_data sec_mipi_esd_refresh_data = {
	...
	.esd_vgh	= PM8058_GPIO_IRQ((NR_MSM_IRQS + NR_GPIO_IRQS), (PMIC_GPIO_ESD_VGH)), // (NR_MSM_IRQS + NR_GPIO_IRQS) = PM8058_IRQ_BASE
};
